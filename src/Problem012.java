 ...
 * adding the natural numbers. So the 7th triangle number would be 1 + 2 + 3 + 4 + 5 + 6 + 7 = 28. 
 ...
 * 1,2,4,7,14,28 We can see that 28 is the first triangle number to have over five divisors. 
